...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            logging.info("Numerical operations completed")
            logging.info("Categorical operations completed")
    ...
    def initiate_data_transformations(self,train_path, test_path):
        ...
        try:
            ...
            logging.info(
                f"Applying preprocessing object for training df and testing df"
                )
